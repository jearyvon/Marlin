...
#define STRING_CONFIG_H_AUTHOR "JearyVon" // Who made the changes.
...
#define PID_K1 0.85      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  15,  15 }
    #define DEFAULT_Ki_LIST {   0.95,   0.95 }
    #define DEFAULT_Kd_LIST { 65.0, 65.0 }
  #else
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 4000, 4000, 100, 15000 } // ...or, set your own edit limits
#endif
